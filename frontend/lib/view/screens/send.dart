                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.symmetric(horizontal: displayWidth * 0.05),
                              color: Colors.white,
                              child: TextFormField(
                                ...
                                Container(
                                  ...
                                  child: DropdownButtonHideUnderline(
                                    child: DropdownButton2(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  width: 50,
                                                  child:
                                                      Image.asset(dropdownValueOfSecond.imagePath),
                                                ),
                                              ],
                                            ),
                                          ),
                                      ...
                                      items: tokenList.map<DropdownMenuItem<Token>>((Token value) {
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.symmetric(
                                            horizontal: 15, vertical: displayHeight * 0.026),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            SizedBox(
                                              height: 50,
                                              width: 50,
                                              child: Image.asset(dropdownValueOfThird.imagePath),
                                            ),
                                          ],
                                        ),
                                      ),
