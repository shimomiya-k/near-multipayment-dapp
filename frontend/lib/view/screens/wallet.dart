            ...
            children: [
              ...
              SizedBox(
                ...
                child: Align(
                  ...
                  child: Text('Wallet', style: Theme.of(context).textTheme.headline1),
                ),
              ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              maxLines: 1,
                              style: TextStyle(fontSize: 35, color: HexColor('#56CCC5')),
                            ),
                          ),
                    ...
                    GestureDetector(
                      onTap: () async {
                        await showDialog(
                          context: context,
                          builder: (_) => QRCode(
                            qrImage: QrImage(data: contractModel.account, size: 200),
                          ),
                        );
                      },
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            height: 22,
                            width: 22,
                            child: SvgPicture.asset('assets/pop.svg', color: Colors.grey),
                          ),
                          const Text(
                            ' display QR code',
                            style: TextStyle(
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton2(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  SizedBox(
                                                    height: 50,
                                                    width: 50,
                                                    child: Image.asset(dropdownValue.imagePath),
                                                  ),
                                                ],
                                              ),
                                            ),
                                        ...
                                        items:
                                            tokenList.map<DropdownMenuItem<Token>>((Token value) {
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () async {
                                        await contractModel.sendTransaction(
                                          ...
                                          'distributeToken',
                                          [
                                            EthereumAddress.fromHex(dropdownValue.address),
                                            BigInt.from(100),
                                            EthereumAddress.fromHex(contractModel.account),
                                          ],
                                        );
                                      },
                                      child: Text(
