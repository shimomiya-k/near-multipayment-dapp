...
contract SwapContract {
    ...
    function calculateValue(
        ...
        value =
            ...
            ERC20(tokenRecieveMesureAddress).balanceOf(address(this));
    }
    ...
    function distributeToken(
        ...
        require(
            ...
            "Anyone but depoyer can distribute token!"
        );
    ...
    function swap(
        ...
        uint256 recieveTokenValue = calculateValue(
            receiveTokenAddress,
            measureTokenAddress
        );
        ...
        require(
            receiveToken.balanceOf(address(this)) >= recieveAmount,
